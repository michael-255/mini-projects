...
- [ ] Make this app a trimmed down version of your template app

- [ ] `Research` GitHub actions for your projects

  - [ ] `Tests` Must pass all tests for PR to be merged
  - [ ] `Linting` Must pass all linting for PR to be merged
  - [ ] `Deployment` Auto deploys if other steps pass

- [ ] `Projects`

  - [ ] `ID Generator`
  - [ ] Look at list from `Blog`
